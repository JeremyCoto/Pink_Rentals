...
BEGIN
    ...
    FIDE_PROYECTO_FINAL_PKG.FIDE_ASIGNACION_INSERTAR_SP(10012, 'Instalación Pista 4x5m', 1005, 912);
    ...
    -- ==========================================================================
    -- EVENTO 11: Sesión Fotos Corporativa (Cliente 35 - Héctor Mata)
    -- ==========================================================================
    ...
    DBMS_OUTPUT.PUT_LINE('>>> CARGA MASIVA TRANSACCIONAL FINALIZADA CON ÉXITO <<<');
END;
/